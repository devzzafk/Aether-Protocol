...
Get a free PostgreSQL database from Neon or Supabase.
...
Add a Vercel Postgres database (Storage tab in dashboard)
Set DATABASE_URL from Vercel Postgres connection string
Deploy — Vercel runs prisma generate automatically
